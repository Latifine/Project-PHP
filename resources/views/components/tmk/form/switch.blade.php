...
<label
    {{ $attributes->merge(['class' => "$cursor border border-gray-300 rounded-md text-center font-semibold uppercase text-xs h-12 w-16 inline-flex flex-wrap overflow-hidden"]) }}>
