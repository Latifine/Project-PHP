<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-3">
            <x-label for="street_number" value="{{ __('Straat en huisnummer') }}" />
            <x-input id="street_number" type="text" class="mt-1 block w-full" wire:model="state.street_number" required autocomplete="street_number" />
        ...
        <div class="col-span-3">
            <x-label for="municipality" value="{{ __('Gemeente') }}" />
            <x-input id="municipality" type="text" class="mt-1 block w-full" wire:model="state.municipality" required autocomplete="municipality" />
